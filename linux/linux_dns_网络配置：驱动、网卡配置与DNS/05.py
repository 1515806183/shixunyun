    ...
    try:
        if os.path.exists(linux_txt_5):
            ...
            with open(save_address, 'a+') as f:
                if num_1 or num_2:
                    f.write("LINUX系统基本组成题目五：执行命令crontab -l输出正确, ---ok" + '\n')
                else:
                    f.write("LINUX系统基本组成题目五：执行命令crontab -l输出不正确, ---error" + '\n')
        ...
        print("LINUX安装与配置题目五:\033[0;34m失败\033[0m")
        raise

    else:
        print("LINUX安装与配置题目五:成功")
